  ...
  return (
    <div className="min-h-screen bg-black text-slate-100">
      <div className="mx-auto max-w-4xl px-6 py-10 md:px-10">
        ...
        <h1 className="mt-6 text-3xl font-semibold tracking-tight text-cyan-300">Project Visibility</h1>
        <p className="mt-3 text-sm text-slate-400">Hide/Show works on The Stage controls will live here.</p>
      </div>
    </div>
  );
};
